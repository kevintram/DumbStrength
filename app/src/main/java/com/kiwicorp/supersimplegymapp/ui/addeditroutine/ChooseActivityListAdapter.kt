...
import com.kiwicorp.supersimplegymapp.ui.activites.ActivitiesListAdapter
...
class ChooseActivityListAdapter(private val viewModel: AddEditRoutineViewModel):
    ...
    class CheckableActivityViewHolder(private val binding: ItemCheckableActivityBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(activity: Activity, viewModel: AddEditRoutineViewModel) {
        ...
        private fun activityIsInEntries(activity: Activity, entriesWithActivityWorkout: List<RoutineEntryWithActivity>): Boolean {
